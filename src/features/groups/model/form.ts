...
const groupFormDomain = createDomain();

export interface GroupFormValues extends Omit<Tag, 'id' | 'roomId'> {}
...
export const form = createForm<GroupFormValues>({
	fields: {
		name: {
			init: 'Name',
